...
// GET /api/search/founders - Search founders with filters
export async function GET(request: NextRequest) {
  try {
    ...
    // Build filter
    const filter: Record<string, unknown> = { role: 'founder' };
    ...
    const validSortFields = ['verificationLevel', 'createdAt', 'name'];
