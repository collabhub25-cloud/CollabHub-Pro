            ...
            <main className="flex-1 flex items-center justify-center px-6 py-12 relative">
                ...
                <div className="w-full max-w-sm relative z-10">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl text-sm font-medium border border-border/80 bg-white hover:bg-accent transition-all duration-200 hover:shadow-sm mb-6"
                    >
